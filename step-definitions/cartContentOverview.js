...
let Cartwindow = require('../cartwindow.js');
...
module.exports = function() {
    ...
    this.Given(/^that the user has a shopping cart that is not empty$/, function(callback) {
    ...
    this.Then(/^the user should see the products and the quantity of each product in the shopping cart$/, function(callback) {
    ...
    this.Then(/^the shopping cart should be displayed as empty$/, function(callback) {
        console.log(emptyCart);
        // Write code here that turns the phrase above into concrete actions
        callback();
    });

    this.Given(/^that the user has added a product to the shopping cart$/, function(callback) {
